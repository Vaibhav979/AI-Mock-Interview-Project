...
public class HumeService {
        ...
        public byte[] callHumeTTS(String text) {
                ...
                String cleanedText = sanitizeTextForTTS(geminiFeedback);
humeService.callTTS(cleanedText);
        ...
        public String sanitizeTextForTTS(String input) {
    return input
            .replaceAll("[`*~_]", "") // remove backticks, asterisks, etc.
