...
const StartMockInterview = () => {
  ...
  const handleGenerate = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:8080/api/generateQuestions", {
        role,
        skills,
      });
  ...
  return (
    <div className="max-w-3xl mx-auto mt-10 p-6 bg-white rounded-2xl shadow-md">
      <h2 className="text-2xl font-bold mb-4 text-center">Start Your Mock Interview</h2>
