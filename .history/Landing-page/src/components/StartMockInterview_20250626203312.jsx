...
const StartMockInterview = () => {
  ...
  return (
    <div>
      ...
      <div className="max-w-3xl mx-auto mt-10 p- rounded-2xl shadow-md">
        <h2 className="text-3xl sm:text-5xl lg:text-6xl tracking-wide">
          Start Your <span className="bg-gradient-to-r from-orange-t500 to-orange-800 text-transparent bg-clip-text">Mock Interview</span>
        </h2>
